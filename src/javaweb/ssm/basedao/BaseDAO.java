...
public abstract class BaseDAO<T> {
    ...
    public BaseDAO(){
        ...
        try {
            ...
            e.printStackTrace();
            throw new FruitDAOException("constructor have problems");
        }
    ...
    //执行查询，返回单个实体对象
    protected T load(String sql, Object... params) throws NoSuchFieldException, IllegalAccessException, SQLException, InstantiationException {
        conn = getConn();
        psmt = conn.prepareStatement(sql);
        setParams(psmt, params);
        rs = psmt.executeQuery();
    ...
    //执行查询，返回List
    protected List<T> executeQuery(String sql, Object... params) throws NoSuchFieldException, IllegalAccessException, SQLException, InstantiationException {
